...
* Made images and links behave like standard Markdown (now they won't render when there are spaces between label/alt-text and URL)
* Only support atx-style headings
* Removed smart periods, quotes, angles & backticks
